...
const COSTable = () => {
  ...
  const getCOSData = `${process.env.REACT_APP_BACKEND_URL}/api/user/getMaturityData?type=COS`;
  const setCOSData = `${process.env.REACT_APP_BACKEND_URL}/api/user/uploadMaturityData?type=COS`;
