...
const CFTable = () => {
  ...
  const getCfData = `${process.env.REACT_APP_BACKEND_URL}/api/user/getMaturityData?type=CF`;
  const setCfData = `${process.env.REACT_APP_BACKEND_URL}/api/user/uploadMaturityData?type=CF`;
