...
const TASTable = () => {
  ...
  const getTASData = `${process.env.REACT_APP_BACKEND_URL}/api/user/getMaturityData?type=TAS`;
  const setTASData = `${process.env.REACT_APP_BACKEND_URL}/api/user/uploadMaturityData?type=TAS`;
  useEffect(() => {
