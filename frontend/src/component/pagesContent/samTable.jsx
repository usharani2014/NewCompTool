...
const SAMTable = () => {
  ...
  const getSAMData = `${process.env.REACT_APP_BACKEND_URL}/api/user/getMaturityData?type=SAM`;
  const setSAMData = `${process.env.REACT_APP_BACKEND_URL}/api/user/uploadMaturityData?type=SAM`;
